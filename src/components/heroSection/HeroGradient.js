const HeroGradient = () => {
  return (
    <div>
      ...
      <div className="shadow-blueMediumShadow absolute top-0 right-0 -z-10 animate-pulse"></div>
      <div className="shadow-blueMediumShadow absolute top-[10%] left-0 -z-10 opacity-50"></div>
    </div>
  );
};
